...
describe('ThemeService', () => {
  ...
  it('should set Green theme on LocalStorage', () => {
    service.setTheme(ThemeList.Green);
    expect(service.storedTheme).toBe(ThemeList.Green);
  });

  it('should set dark Green on document body', () => {
    service.setTheme(ThemeList.Green);
    const bodyClasses = document.body.classList;
    expect(bodyClasses.contains(ThemeList.Green)).toBeTruthy();
  });
});
